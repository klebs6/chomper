...
our role Punctuation::Rules {
    ...
    token tok-dot-dot     { ..  } #Range, Struct expressions, Patterns, Range Patterns
    token tok-dot-dot-dot { ... } #Variadic functions, Range patterns
    token tok-dot-dot-eq  { ..= } #Inclusive Range, Range patterns
    ...
    token tok-fat-arrow   { =>  } #Match arms, Macros
