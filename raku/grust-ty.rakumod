...
our role Ty::Rules {
    ...
    rule ty:sym<c> { '<' <ty-sum> <maybe-as-trait-ref> '>' <tok-mod-sep> <ident> }
    rule ty:sym<d> { <tok-shl> <ty-sum> <maybe-as-trait-ref> '>' <tok-mod-sep> <ident> <maybe-as-trait-ref> '>' <tok-mod-sep> <ident> }
